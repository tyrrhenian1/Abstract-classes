...
namespace Abstract
{
    class FazzyNumber : Pair
    {
        ...
        public FazzyNumber(int a, int b, int a1, int a2, int b1, int b2,string func) : base(a, b, a1, a2, b1, b2)
        {
            Func = func;
        }
        public FazzyNumber(int a,int a1,int a2,string func):base(a,a1,a2)
        {
            Func = func;
        }
